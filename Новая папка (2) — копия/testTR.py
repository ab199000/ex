from proverkaTR import proverka
import unittest
class TestTriangleCheck(unittest.TestCase):

    def gran1_triangle(self):
        self.assertEqual(proverka(
            -2147483646, -2147483647, -2147483648), "Это невозможный треугольник. Стороны треугольника не могут быть меньше или равны нулю")
    def gran_triangle(self):
        self.assertEqual(proverka(
            2147483646, 2147483647, 2147483648), "Это разносторонний треугольник. Площадь = 1.9969186231178143e+18")
